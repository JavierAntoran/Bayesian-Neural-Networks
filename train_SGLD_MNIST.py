...
parser.add_argument('--use_preconditioning', type=float, nargs='?', action='store', default=0.1,
                    help='Use RMSprop preconditioning. Default: 0.1.')
...
parser.add_argument('--lr', type=float, nargs='?', action='store', default=1e-3,
                    help='learning rate. I recoment 1e-3 if preconditioning, else 1e-4. Default: 1e-3.')
