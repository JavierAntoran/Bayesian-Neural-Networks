...
We performed heteroscedastic regression on the six UCI datasets (housing, concrete, energy efficiency, power plant, red wine and [yacht](http://archive.ics.uci.edu/ml/datasets/yacht+hydrodynamics) datasets).
